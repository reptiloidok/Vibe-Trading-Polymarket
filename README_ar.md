...
| **Polymarket** | أسواق التنبؤ | قراءة (Gamma/Data API العامة، بدون مفتاح) + تداول ورقي **محاكى محلياً** فقط — لا يوجد حساب تجريبي من المزوّد، ولا يُدعم تنفيذ الأوامر الحية بعد |
