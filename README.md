...
| **Polymarket** | prediction markets | read (public Gamma/Data API, no key) + **locally-simulated** paper trading only — no vendor demo account, no live order placement yet |
