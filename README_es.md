...
| **Polymarket** | mercados de predicción | lectura (Gamma/Data API pública, sin clave) + paper **simulado localmente** únicamente — sin cuenta demo del proveedor, sin colocación de órdenes live todavía |
